...
task main(){
	motor[rMotor] = MAX/2; // right motor at half speed
	motor[lMotor] = MAX/2; // left motor at half speed
	wait1Msec(1000); // wait 1s
	motor[rMotor] = -MAX/2; // invert speed
	motor[lMotor] = -motor[lMotor]; // invert speed
	wait1Msec(1000); // wait 1s
}
